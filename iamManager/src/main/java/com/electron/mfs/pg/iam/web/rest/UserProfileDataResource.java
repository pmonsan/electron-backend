...
import com.electron.mfs.pg.iam.service.UserProfileDataService;
import com.electron.mfs.pg.iam.web.rest.errors.BadRequestAlertException;
import com.electron.mfs.pg.iam.service.dto.UserProfileDataDTO;
...
/**
 * REST controller for managing {@link com.electron.mfs.pg.iam.domain.UserProfileData}.
 */
@RestController
@RequestMapping("/api")
public class UserProfileDataResource {
    ...
    private static final String ENTITY_NAME = "iamManagerUserProfileData";
