...
/**
 * REST controller for managing {@link com.electron.mfs.pg.subscription.domain.ServiceIntegration}.
 */
@RestController
@RequestMapping("/api")
public class ServiceIntegrationResource {
    ...
    private static final String ENTITY_NAME = "subscriptionManagerServiceIntegration";
