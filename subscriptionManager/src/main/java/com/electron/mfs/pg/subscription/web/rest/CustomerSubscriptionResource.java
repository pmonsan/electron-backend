...
/**
 * REST controller for managing {@link com.electron.mfs.pg.subscription.domain.CustomerSubscription}.
 */
@RestController
@RequestMapping("/api")
public class CustomerSubscriptionResource {
    ...
    private static final String ENTITY_NAME = "subscriptionManagerCustomerSubscription";
