...
/**
 * REST controller for managing {@link com.electron.mfs.pg.transactions.domain.TransactionCommission}.
 */
@RestController
@RequestMapping("/api")
public class TransactionCommissionResource {
    ...
    private static final String ENTITY_NAME = "transactionManagerTransactionCommission";
