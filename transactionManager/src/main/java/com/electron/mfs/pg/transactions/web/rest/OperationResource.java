...
/**
 * REST controller for managing {@link com.electron.mfs.pg.transactions.domain.Operation}.
 */
@RestController
@RequestMapping("/api")
public class OperationResource {
    ...
    private static final String ENTITY_NAME = "transactionManagerOperation";
