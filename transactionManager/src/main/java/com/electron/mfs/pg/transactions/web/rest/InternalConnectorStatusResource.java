...
/**
 * REST controller for managing {@link com.electron.mfs.pg.transactions.domain.InternalConnectorStatus}.
 */
@RestController
@RequestMapping("/api")
public class InternalConnectorStatusResource {
    ...
    private static final String ENTITY_NAME = "transactionManagerInternalConnectorStatus";
