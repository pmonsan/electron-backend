...
/**
 * REST controller for managing {@link com.electron.mfs.pg.transactions.domain.DetailTransaction}.
 */
@RestController
@RequestMapping("/api")
public class DetailTransactionResource {
    ...
    private static final String ENTITY_NAME = "transactionManagerDetailTransaction";
