...
import com.electron.mfs.pg.transactions.service.TransactionPriceService;
import com.electron.mfs.pg.transactions.web.rest.errors.BadRequestAlertException;
import com.electron.mfs.pg.transactions.service.dto.TransactionPriceDTO;
...
/**
 * REST controller for managing {@link com.electron.mfs.pg.transactions.domain.TransactionPrice}.
 */
@RestController
@RequestMapping("/api")
public class TransactionPriceResource {
    ...
    private static final String ENTITY_NAME = "transactionManagerTransactionPrice";
