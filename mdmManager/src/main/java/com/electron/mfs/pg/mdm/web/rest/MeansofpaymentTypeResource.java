...
import com.electron.mfs.pg.mdm.service.MeansofpaymentTypeService;
...
/**
 * REST controller for managing {@link com.electron.mfs.pg.mdm.domain.MeansofpaymentType}.
 */
@RestController
@RequestMapping("/api")
public class MeansofpaymentTypeResource {
    ...
    private static final String ENTITY_NAME = "mdmManagerMeansofpaymentType";
