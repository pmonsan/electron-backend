...
import com.electron.mfs.pg.mdm.service.TransactionStatusService;
...
/**
 * REST controller for managing {@link com.electron.mfs.pg.mdm.domain.TransactionStatus}.
 */
@RestController
@RequestMapping("/api")
public class TransactionStatusResource {
    ...
    private static final String ENTITY_NAME = "mdmManagerTransactionStatus";
