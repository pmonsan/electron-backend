...
import com.electron.mfs.pg.mdm.service.AccountTypeService;
...
/**
 * REST controller for managing {@link com.electron.mfs.pg.mdm.domain.AccountType}.
 */
@RestController
@RequestMapping("/api")
public class AccountTypeResource {
    ...
    private static final String ENTITY_NAME = "mdmManagerAccountType";
