...
import com.electron.mfs.pg.mdm.service.PersonGenderService;
...
/**
 * REST controller for managing {@link com.electron.mfs.pg.mdm.domain.PersonGender}.
 */
@RestController
@RequestMapping("/api")
public class PersonGenderResource {
    ...
    private static final String ENTITY_NAME = "mdmManagerPersonGender";
