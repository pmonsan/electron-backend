...
import com.electron.mfs.pg.mdm.service.PgDataService;
...
/**
 * REST controller for managing {@link com.electron.mfs.pg.mdm.domain.PgData}.
 */
@RestController
@RequestMapping("/api")
public class PgDataResource {
    ...
    private static final String ENTITY_NAME = "mdmManagerPgData";
