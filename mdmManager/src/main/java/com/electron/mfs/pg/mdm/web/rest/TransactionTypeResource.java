...
import com.electron.mfs.pg.mdm.service.TransactionTypeService;
...
/**
 * REST controller for managing {@link com.electron.mfs.pg.mdm.domain.TransactionType}.
 */
@RestController
@RequestMapping("/api")
public class TransactionTypeResource {
    ...
    private static final String ENTITY_NAME = "mdmManagerTransactionType";
