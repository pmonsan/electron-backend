...
import com.electron.mfs.pg.mdm.service.TransactionGroupService;
import com.electron.mfs.pg.mdm.web.rest.errors.BadRequestAlertException;
import com.electron.mfs.pg.mdm.service.dto.TransactionGroupDTO;
...
/**
 * REST controller for managing {@link com.electron.mfs.pg.mdm.domain.TransactionGroup}.
 */
@RestController
@RequestMapping("/api")
public class TransactionGroupResource {
    ...
    private static final String ENTITY_NAME = "mdmManagerTransactionGroup";
