...
/**
 * REST controller for managing {@link com.electron.mfs.pg.mdm.domain.BeneficiaryRelationship}.
 */
@RestController
@RequestMapping("/api")
public class BeneficiaryRelationshipResource {
    ...
    private static final String ENTITY_NAME = "mdmManagerBeneficiaryRelationship";
