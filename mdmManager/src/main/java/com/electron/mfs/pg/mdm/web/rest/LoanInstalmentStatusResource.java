...
/**
 * REST controller for managing {@link com.electron.mfs.pg.mdm.domain.LoanInstalmentStatus}.
 */
@RestController
@RequestMapping("/api")
public class LoanInstalmentStatusResource {
    ...
    private static final String ENTITY_NAME = "mdmManagerLoanInstalmentStatus";
