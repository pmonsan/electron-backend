...
/**
 * REST controller for managing {@link com.electron.mfs.pg.pg8583client.domain.Pg8583Callback}.
 */
@RestController
@RequestMapping("/api")
public class Pg8583CallbackResource {
    ...
    private static final String ENTITY_NAME = "pg8583ClientPg8583Callback";
