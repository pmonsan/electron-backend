...
import com.electron.mfs.pg.agent.web.rest.errors.BadRequestAlertException;
...
/**
 * REST controller for managing {@link com.electron.mfs.pg.agent.domain.AgentType}.
 */
@RestController
@RequestMapping("/api")
public class AgentTypeResource {
    ...
    private static final String ENTITY_NAME = "agentManagerAgentType";
