...
/**
 * REST controller for managing {@link com.electron.mfs.pg.pg8583.domain.PgDetailMessage}.
 */
@RestController
@RequestMapping("/api")
public class PgDetailMessageResource {
    ...
    private static final String ENTITY_NAME = "pg8583ManagerPgDetailMessage";
