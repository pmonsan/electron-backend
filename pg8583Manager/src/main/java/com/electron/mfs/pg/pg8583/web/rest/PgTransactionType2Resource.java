...
/**
 * REST controller for managing {@link com.electron.mfs.pg.pg8583.domain.PgTransactionType2}.
 */
@RestController
@RequestMapping("/api")
public class PgTransactionType2Resource {
    ...
    private static final String ENTITY_NAME = "pg8583ManagerPgTransactionType2";
