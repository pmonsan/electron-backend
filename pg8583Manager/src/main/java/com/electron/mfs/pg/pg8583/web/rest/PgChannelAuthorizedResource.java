...
import com.electron.mfs.pg.pg8583.service.PgChannelAuthorizedService;
...
/**
 * REST controller for managing {@link com.electron.mfs.pg.pg8583.domain.PgChannelAuthorized}.
 */
@RestController
@RequestMapping("/api")
public class PgChannelAuthorizedResource {
    ...
    private static final String ENTITY_NAME = "pg8583ManagerPgChannelAuthorized";
