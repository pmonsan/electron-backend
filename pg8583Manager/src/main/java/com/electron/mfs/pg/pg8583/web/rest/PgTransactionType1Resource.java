...
/**
 * REST controller for managing {@link com.electron.mfs.pg.pg8583.domain.PgTransactionType1}.
 */
@RestController
@RequestMapping("/api")
public class PgTransactionType1Resource {
    ...
    private static final String ENTITY_NAME = "pg8583ManagerPgTransactionType1";
