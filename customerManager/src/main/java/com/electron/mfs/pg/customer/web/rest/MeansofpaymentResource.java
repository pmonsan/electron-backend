...
/**
 * REST controller for managing {@link com.electron.mfs.pg.customer.domain.Meansofpayment}.
 */
@RestController
@RequestMapping("/api")
public class MeansofpaymentResource {
    ...
    private static final String ENTITY_NAME = "customerManagerMeansofpayment";
