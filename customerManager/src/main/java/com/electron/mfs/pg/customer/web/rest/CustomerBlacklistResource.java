...
/**
 * REST controller for managing {@link com.electron.mfs.pg.customer.domain.CustomerBlacklist}.
 */
@RestController
@RequestMapping("/api")
public class CustomerBlacklistResource {
    ...
    private static final String ENTITY_NAME = "customerManagerCustomerBlacklist";
