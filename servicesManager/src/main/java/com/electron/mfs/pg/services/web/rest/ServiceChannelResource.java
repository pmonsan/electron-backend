...
import com.electron.mfs.pg.services.service.ServiceChannelService;
import com.electron.mfs.pg.services.web.rest.errors.BadRequestAlertException;
import com.electron.mfs.pg.services.service.dto.ServiceChannelDTO;
...
/**
 * REST controller for managing {@link com.electron.mfs.pg.services.domain.ServiceChannel}.
 */
@RestController
@RequestMapping("/api")
public class ServiceChannelResource {
    ...
    private static final String ENTITY_NAME = "servicesManagerServiceChannel";
