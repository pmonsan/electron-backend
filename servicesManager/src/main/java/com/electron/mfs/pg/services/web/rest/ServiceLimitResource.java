...
import com.electron.mfs.pg.services.service.ServiceLimitService;
...
/**
 * REST controller for managing {@link com.electron.mfs.pg.services.domain.ServiceLimit}.
 */
@RestController
@RequestMapping("/api")
public class ServiceLimitResource {
    ...
    private static final String ENTITY_NAME = "servicesManagerServiceLimit";
