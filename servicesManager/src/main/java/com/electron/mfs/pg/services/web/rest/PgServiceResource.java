...
import com.electron.mfs.pg.services.service.PgServiceService;
...
/**
 * REST controller for managing {@link com.electron.mfs.pg.services.domain.PgService}.
 */
@RestController
@RequestMapping("/api")
public class PgServiceResource {
    ...
    private static final String ENTITY_NAME = "servicesManagerPgService";
