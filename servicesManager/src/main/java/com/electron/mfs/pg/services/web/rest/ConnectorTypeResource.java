...
/**
 * REST controller for managing {@link com.electron.mfs.pg.services.domain.ConnectorType}.
 */
@RestController
@RequestMapping("/api")
public class ConnectorTypeResource {
    ...
    private static final String ENTITY_NAME = "servicesManagerConnectorType";
