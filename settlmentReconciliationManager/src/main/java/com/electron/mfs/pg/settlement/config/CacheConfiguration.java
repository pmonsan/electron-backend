...
public class CacheConfiguration implements DisposableBean {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("settlmentReconciliationManager");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("settlmentReconciliationManager");
        ...
        config.getMapConfigs().put("com.electron.mfs.pg.settlement.domain.*", initializeDomainMapConfig(jHipsterProperties));
