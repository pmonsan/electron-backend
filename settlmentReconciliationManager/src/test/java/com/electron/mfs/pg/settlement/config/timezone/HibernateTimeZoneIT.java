package com.electron.mfs.pg.settlement.config.timezone;

import com.electron.mfs.pg.settlement.SettlmentReconciliationManagerApp;
import com.electron.mfs.pg.settlement.config.SecurityBeanOverrideConfiguration;
import com.electron.mfs.pg.settlement.repository.timezone.DateTimeWrapper;
import com.electron.mfs.pg.settlement.repository.timezone.DateTimeWrapperRepository;
 ...
 */
@EmbeddedKafka
@SpringBootTest(classes = {SecurityBeanOverrideConfiguration.class, SettlmentReconciliationManagerApp.class})
