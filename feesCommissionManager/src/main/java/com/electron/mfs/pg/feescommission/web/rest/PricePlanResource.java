...
import com.electron.mfs.pg.feescommission.service.PricePlanService;
...
/**
 * REST controller for managing {@link com.electron.mfs.pg.feescommission.domain.PricePlan}.
 */
@RestController
@RequestMapping("/api")
public class PricePlanResource {
    ...
    private static final String ENTITY_NAME = "feesCommissionManagerPricePlan";
