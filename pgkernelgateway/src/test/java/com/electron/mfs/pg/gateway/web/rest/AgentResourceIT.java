...
import com.electron.mfs.pg.gateway.repository.AgentRepository;
import com.electron.mfs.pg.gateway.service.AgentService;
import com.electron.mfs.pg.gateway.service.dto.AgentDTO;
import com.electron.mfs.pg.gateway.service.mapper.AgentMapper;
...
public class AgentResourceIT {
    ...
    private static final String DEFAULT_EMAIL = "`w@-7.7x";
    ...
    private static final String DEFAULT_BUSINESS_EMAIL = "=p@}.a";
    private static final String UPDATED_BUSINESS_EMAIL = "/d@j.e";
