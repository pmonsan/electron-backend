...
import com.electron.mfs.pg.gateway.repository.PartnerRepository;
import com.electron.mfs.pg.gateway.service.PartnerService;
import com.electron.mfs.pg.gateway.service.dto.PartnerDTO;
import com.electron.mfs.pg.gateway.service.mapper.PartnerMapper;
...
public class PartnerResourceIT {
    ...
    private static final String DEFAULT_BUSINESS_EMAIL = "B@g.?e";
    private static final String UPDATED_BUSINESS_EMAIL = ",e@-5.qa";
