...
import com.electron.mfs.pg.gateway.domain.UserProfile;
import com.electron.mfs.pg.gateway.repository.UserProfileRepository;
import com.electron.mfs.pg.gateway.service.UserProfileService;
import com.electron.mfs.pg.gateway.service.dto.UserProfileDTO;
import com.electron.mfs.pg.gateway.service.mapper.UserProfileMapper;
...
public class UserProfileResourceIT {
    ...
    public void createUserProfile() throws Exception {
        ...
        assertThat(testUserProfile.getCreationDate()).isEqualTo(DEFAULT_CREATION_DATE);
        assertThat(testUserProfile.getDescription()).isEqualTo(DEFAULT_DESCRIPTION);
        assertThat(testUserProfile.getUpdateDate()).isEqualTo(DEFAULT_UPDATE_DATE);
    }
    ...
    public void checkCreationDateIsRequired() throws Exception {
        int databaseSizeBeforeTest = userProfileRepository.findAll().size();
        // set the field null
        userProfile.setCreationDate(null);
    ...
    public void updateUserProfile() throws Exception {
        ...
        assertThat(testUserProfile.getCreationDate()).isEqualTo(UPDATED_CREATION_DATE);
        assertThat(testUserProfile.getDescription()).isEqualTo(UPDATED_DESCRIPTION);
        assertThat(testUserProfile.getUpdateDate()).isEqualTo(UPDATED_UPDATE_DATE);
    }
