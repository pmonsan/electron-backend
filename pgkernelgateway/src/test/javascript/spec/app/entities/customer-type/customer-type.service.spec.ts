...
describe('Service Tests', () => {
  describe('CustomerType Service', () => {
    ...
    describe('Service methods', () => {
      ...
      it('should create a CustomerType', async () => {
      ...
      it('should update a CustomerType', async () => {
        const returnedFromService = Object.assign(
          {
            code: 'BBBBBB',
            label: 'BBBBBB',
      ...
      it('should return a list of CustomerType', async () => {
        const returnedFromService = Object.assign(
          {
            code: 'BBBBBB',
            label: 'BBBBBB',
      ...
      it('should delete a CustomerType', async () => {
