...
describe('Service Tests', () => {
  describe('Connector Service', () => {
    ...
    beforeEach(() => {
      ...
      expectedResult = {};
      injector = getTestBed();
      service = injector.get(ConnectorService);
      httpMock = injector.get(HttpTestingController);

      elemDefault = new Connector(0, 'AAAAAAA', 'AAAAAAA', 'AAAAAAA', 'AAAAAAA', 'AAAAAAA', 'AAAAAAA', false);
    });
    ...
    describe('Service methods', () => {
      ...
      it('should return a list of Connector', async () => {
        const returnedFromService = Object.assign(
          {
            code: 'BBBBBB',
            label: 'BBBBBB',
