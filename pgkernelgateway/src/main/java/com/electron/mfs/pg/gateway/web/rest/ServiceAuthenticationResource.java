...
/**
 * REST controller for managing {@link com.electron.mfs.pg.gateway.domain.ServiceAuthentication}.
 */
@RestController
@RequestMapping("/api")
public class ServiceAuthenticationResource {
    ...
    private static final String ENTITY_NAME = "serviceAuthentication";
