...
/**
 * REST controller for managing {@link com.electron.mfs.pg.gateway.domain.InternalConnectorRequest}.
 */
@RestController
@RequestMapping("/api")
public class InternalConnectorRequestResource {
    ...
    private static final String ENTITY_NAME = "internalConnectorRequest";
