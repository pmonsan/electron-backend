...
To build the final jar and optimize the pgkernelgateway application for production, run:
...
Then navigate to [http://localhost:21003](http://localhost:21003) in your browser.
