package com.electron.mfs.pg.uaa.config;
...
public class CacheConfiguration implements DisposableBean {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("pgkerneluaa");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("pgkerneluaa");
        ...
        config.getMapConfigs().put("com.electron.mfs.pg.uaa.domain.*", initializeDomainMapConfig(jHipsterProperties));
