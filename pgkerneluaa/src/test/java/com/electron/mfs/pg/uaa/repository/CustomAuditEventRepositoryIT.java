package com.electron.mfs.pg.uaa.repository;

import com.electron.mfs.pg.uaa.PgkerneluaaApp;
import com.electron.mfs.pg.uaa.config.Constants;
import com.electron.mfs.pg.uaa.config.audit.AuditEventConverter;
import com.electron.mfs.pg.uaa.domain.PersistentAuditEvent;
...
import static com.electron.mfs.pg.uaa.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
